...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field users on 'Queue'
        db.create_table('helpdesk_queue_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('queue', models.ForeignKey(orm['helpdesk.queue'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('helpdesk_queue_users', ['queue_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field users on 'Queue'
        db.delete_table('helpdesk_queue_users')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 20, 13, 13, 15, 387617)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
